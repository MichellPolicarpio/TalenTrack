    ...
    <Popover>
      ...
      <PopoverContent align="center" className="w-[210px] p-0 overflow-hidden border-border bg-popover shadow-xl ring-1 ring-black/5">
        <div className="flex h-60">
          ...
          {/* Years Column */}
          <div className="flex flex-1 flex-col overflow-y-auto py-1 bg-muted/30 scrollbar-thin scrollbar-thumb-neutral-200 scrollbar-track-transparent hover:scrollbar-thumb-neutral-300">
            <div className="sticky top-0 bg-muted/95 backdrop-blur px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">
              Year
            </div>
            <div className="px-1">
              {YEARS.map((y) => (
