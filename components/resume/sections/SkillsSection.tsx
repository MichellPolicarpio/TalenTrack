...
function SkillCard({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative flex items-center gap-3 rounded-xl border border-border/50 bg-card p-4 transition-all hover:border-border/80 hover:shadow-md sm:gap-4 sm:p-5",
