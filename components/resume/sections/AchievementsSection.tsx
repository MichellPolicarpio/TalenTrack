...
function AchievementCard({
  ...
  const titleEmpty = showValidation && !form.title.trim();
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative flex items-start gap-3 rounded-xl border border-border/50 bg-card p-4 transition-all hover:border-border/80 hover:shadow-md sm:gap-4 sm:p-5",
        isDragging && "z-50 opacity-50",
        !item.isVisibleOnResume && "opacity-60 bg-muted/20",
      )}
    >
      ...
      <div className="flex-1 space-y-3">
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            <Label className="text-[12px] text-[#6B7280]">Title <span className="text-red-500">*</span></Label>
          ...
          <Input
            ...
            disabled={disabled}
            className={cn("text-[11pt] font-semibold", titleEmpty ? "border-red-400 focus-visible:ring-red-400" : "")}
          />
        </div>
...
function AchievementForm({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-border/50 bg-card p-4 shadow-sm sm:gap-4 sm:p-5">
      <div className="flex flex-col gap-2">
        ...
        <Input 
          ...
          className={titleEmpty ? "border-red-400 focus-visible:ring-red-400" : ""}
        />
      </div>
