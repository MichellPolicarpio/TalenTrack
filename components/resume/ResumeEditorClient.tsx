            ...
            <div className="flex flex-1 min-h-0 overflow-hidden">
              ...
              <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-transparent">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-1 flex-col overflow-hidden">
                  <div className="flex shrink-0 w-full min-w-0 items-center bg-transparent pb-4">
                    <div className="flex flex-1 items-stretch gap-1.5 overflow-hidden py-1 lg:py-2">
                      ...
                      <div
                        ...
                        className="min-h-9 min-w-0 flex-1 overflow-x-auto scroll-smooth rounded-xl border border-border/50 bg-muted/30 scrollbar-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                      >
                        <TabsList
                          variant="default"
                          ...
                          {TABS.map((tab) => {
                            ...
                            return (
                              <TabsTrigger
                                key={tab.value}
                                value={tab.value}
                                className="h-8 shrink-0 gap-2 rounded-full border-0 bg-transparent px-4 text-[12px] font-semibold text-foreground/50 transition-all duration-200 data-active:bg-primary data-active:text-white data-active:shadow-md data-active:hover:text-white hover:bg-accent hover:text-foreground dark:data-active:bg-primary"
                              >
              ...
              <div className="hidden min-w-0 flex-1 flex-col rounded-3xl bg-card shadow-md border border-border/20 ml-6 overflow-hidden lg:flex">
                {/* Right Header */}
                <div className="flex shrink-0 w-full min-w-0 flex-wrap items-center justify-center gap-x-4 gap-y-2 border-b border-border/20 bg-card px-4 sm:px-6 py-2 min-h-[64px] shadow-sm relative z-10">
                  {(() => {
