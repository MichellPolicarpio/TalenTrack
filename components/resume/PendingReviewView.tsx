        ...
        >
          ...
          >
            ...
            <Button
              ...
              className="h-10 gap-2 rounded-xl bg-primary px-5 text-[13px] font-semibold text-white shadow-sm transition-all hover:bg-primary/90 hover:shadow-md disabled:opacity-60"
            >
              {downloading ? (
                <Loader2 className="size-4 animate-spin" />
              ) : (
