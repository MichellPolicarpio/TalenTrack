...
export function SplashScreen({ 
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-between bg-background px-6 py-12 text-center overflow-hidden"
    >
        {/* Centered Logo */}
        ...
        <div className="flex flex-col items-center gap-12 w-full max-w-sm">
          ...
          <div className="flex w-full flex-col items-center gap-6">
            <p className="h-6 text-[13px] font-medium tracking-wide text-muted-foreground">
              {steps[stepIndex]}
            </p>
            
            <div className="flex w-full max-w-[280px] flex-col items-center gap-3 sm:max-w-[320px]">
              <div className="h-1.5 w-full overflow-hidden rounded-full bg-muted ring-1 ring-border/50">
                <motion.div
              ...
              <p className="text-[9px] font-bold tracking-[0.25em] text-muted-foreground/60 uppercase">
                {Math.round(progress)}%
              </p>
            </div>
          </div>
